...
def main(k, conf_thre, iou_thre):
    img_folder = r'C:\Users\李志卿\datasets\night'
    tp, fp, tn, fn = 0,0,0,0
    res = []
    a_start = 1
    b_start = 1
    ...
    for a in range(a_start, k+1):
        for b in range(b_start, k+1):
            for space in os.listdir(img_folder): 
                ...
                tru_txt_folder = fr'C:\Users\李志卿\datasets\night\{space}\labels'
                pre_txt_folder = fr'D:\白杖实验全部资料\yolov8实验结果\night_yolov8_sol\{space}\labels'
